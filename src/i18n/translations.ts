export const translations = {
  zh: {
    ...
    ai_f_complete: '表單完成',
    ai_ai_title: 'AI 摘要',
    ai_ai_sum: '在我看到任何一則訊息之前，Gemini 就已經幫我把需求整理成摘要、判斷任務類型、找出缺少的資訊，並列好該先問哪些問題。',
    ai_thinking: 'Gemini 正在分析需求…',
    ai_d_summary_lbl: '摘要',
  ...
  en: {
    ...
    ai_ai_sum: 'Before I read a single message, Gemini has already summarised the request, classified the task type, identified missing context, and suggested the first questions.',
    ai_thinking: 'Gemini is analysing the request…',
