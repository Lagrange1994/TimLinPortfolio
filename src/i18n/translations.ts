export const translations = {
  ...
  en: {
    ...
    ai_sources_sum: 'PMs, stakeholders, clients — anything from a LINE message to a Tally form lands in one inbox.',
    ai_d_recent: 'Recent inbound',
    ai_sources_loading: 'Receiving a new message…',
    ai_intake_title: 'Intake',
    ai_intake_sum: 'Make receives each request and normalizes it — source, project type, goal, timeline, priority, and contact all captured in structured fields.',
    ...
    ai_ai_sum: 'Gemini summarizes the request, classifies the task type, identifies missing context, and suggests the first questions — before I read a single message.',
    ai_thinking: 'Gemini is analyzing the request…',
    ai_d_summary_lbl: 'Summary',
    ai_d_summary_text: 'Redesign the <span class="hl">first-run onboarding</span> to introduce a new pricing tier without disrupting the existing free-to-paid funnel. PM signals a Q3 dependency — ship before <span class="hl">Jun 17</span>.',
    ...
    ai_d_m2: 'Pricing tier copy not yet finalized by marketing',
    ai_d_m3: 'Analytics access for the current funnel',
    ai_d_questions_lbl: 'Suggested Questions',
    ai_d_q1: "What's the target lift on tier-2 conversion?",
    ai_d_q2: 'Are existing free users grandfathered in?',
    ai_d_q3: 'Is the iOS / Android rollout simultaneous?',
    ...
    ai_tracking_sum: 'Every structured brief is written to Google Sheets with a stable record ID — a searchable, always-up-to-date intake log.',
    ai_d_sheets_lbl: 'Sheets · Design Requests',
    ai_human_title: 'Human Review',
    ai_human_sum: 'I read the brief, judge priority, confirm strategy, spot risks, and decide the first action — the part that requires design judgment.',
    ...
    ai_hr_priority_val: 'P1 — ship before Jun 17 to unblock pricing launch.',
    ai_hr_strategy_val: 'Augment the existing onboarding rather than fork; smaller surface, faster ship.',
    ai_hr_risks_val: 'Pricing copy unfinalized; analytics access not yet granted; mixed cohort behaviour.',
    ai_hr_nextstep_val: '30-min kickoff w/ PM; request analytics access; capture baseline funnel.',
    ai_hr_op_lbl: 'Operating Principle',
    ai_hr_op_quote: 'AI handles <span class="pivot">structure</span>. I handle <span class="pivot">judgment</span>.',
    ai_workflow_title: 'Design Workflow',
    ai_workflow_sum: 'The brief enters the design pipeline — already structured, prioritized, and contextualized.',
    ...
    ai_principle: 'AI handles <em>structure</em><span class="ai-principle-dot"></span>I handle <em>judgment</em>.',
    // contact
    ...
    chat_greeting: "Hi! I'm Tim's AI assistant. Ask me anything about his design background, portfolio, or availability 👋",
    chat_placeholder: 'Ask anything about Tim…',
    chat_send_aria: 'Send',
    chat_fallback_error: "Couldn't get a reply — please contact Tim directly.",
    chat_network_error: 'Connection failed — please reach out via the contact form.',
    ...
    chat_q4: "What's Tim's design process?",
    chat_q5_label: 'English skills?',
    chat_q5: "How's Tim's English communication?",
