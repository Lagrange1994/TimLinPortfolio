...
export default function PhoneFrame({ src, alt }) {
    return (
        <div className="flex items-center justify-center w-full h-full p-4 lg:p-8">
            <div className="relative h-full w-auto max-w-full aspect-[9/19] border-[6px] md:border-[8px] border-[#2d2d2d] max-lg:rounded-[18.57%/8.8%] lg:rounded-[2.5rem] overflow-hidden shadow-2xl bg-black animate-fadeIn shrink-0">
