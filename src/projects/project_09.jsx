...
// --- COMPONENTS ---
        ...
        const TRANSLATIONS = {
            zh: {
                ...
                conflict_title: "痛點與挑戰", conflict_sub: "解決方案出現前的困境",
                ...
                process_title: "執行過程", process_sub: "從需求分析到最終交付的四個關鍵階段",
                ...
                sol_title: "解決方案與亮點",
                sol_1_title: "視覺化預約系統", sol_1_desc: "整合即時日曆視圖，解決人工登記的衝突痛點。", sol_1_benefit: "透過直觀的日曆視圖，員工可一秒辨識空檔並直接預約，杜絕撞期，大幅節省溝通成本。",
                sol_2_title: "結構化員工通訊錄", sol_2_desc: "打破部門藩籬，建立統一的數位化聯絡中心。", sol_2_benefit: "清晰列出人員職稱、科室與分機，強化跨部門協作效率。",
                sol_3_title: "分級權限管理", sol_3_desc: "針對不同科室與職級設定專屬權限，確保資料流向安全可控。", sol_3_benefit: "針對不同科室設定專屬權限，確保資料流向安全可控。",

                gallery_title: "介面展示", gallery_desc: "點擊下方卡片查看高保真設計。",
                                ...
                                <div className="relative w-full h-full flex flex-col items-center justify-center">
                                    <div className="flex-1 min-h-0 w-full flex items-center justify-center">
                                        <PreviewFrame
                                            ref={imageScrollRef}
                                            resizable
                                            chromeClassName="bg-epb-dark-light"
                                ...
                                <div className="w-full h-full flex flex-col glass-panel relative min-h-0">
                                    ...
                                    <div className="sticky top-0 bg-epb-dark/95 backdrop-blur-xl z-30 border-b border-border/10 shrink-0">
                                        <div className="p-4 lg:p-8 pb-0 lg:pb-0">
                                            ...
                                            <p className="text-text/60 text-xs lg:text-sm mb-2 lg:mb-4">環保局內部整合資訊系統</p>
                                            <TabNav
                                                prefix="epb"
