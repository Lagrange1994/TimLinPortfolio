                        ...
                        <section id="split-view" ref={splitRef} className="snap-section flex flex-col lg:flex-row bg-kh-dark overflow-hidden">
                            <div className="w-full shrink-0 z-20 lg:w-3/5 lg:h-full bg-[#1a1a1a] flex items-center justify-center p-4 lg:p-12 border-b lg:border-b-0 lg:border-r border-border/5 shadow-2xl">
                                <div className="w-full h-[35vh] lg:h-full flex items-center justify-center">
                                    ...
                                    <div className="relative w-full max-w-full max-h-full lg:max-h-[90%] bg-kh-dark-light rounded-xl border border-border/10 shadow-2xl overflow-hidden flex flex-col">
                            ...
                            <div className="flex-1 w-full relative z-10 lg:w-2/5 lg:h-full flex flex-col h-auto min-h-0">
                                <div className="w-full h-full flex flex-col glass-panel relative min-h-0">
                                    ...
                                    <div className="sticky top-0 bg-kh-dark/95 backdrop-blur-xl z-30 border-b border-border/10 shrink-0">
                                        <div className="p-4 lg:p-8 pb-0 lg:pb-0">
                                            ...
                                            <p className="text-text/60 text-xs lg:text-sm mb-2 lg:mb-4">New Generation Smart Technology Investigation System</p>
                                    ...
                                    <div ref={swipeContentRef} className="p-4 lg:p-8 pb-24">
                                        {activeTab === 'context' && (
                                            <div className="space-y-8 lg:space-y-12 animate-fadeIn">
                                                ...
                                                <div className="space-y-6">
                                                    <h3 className="text-lg md:text-2xl font-bold text-text mb-2 lg:mb-4 flex items-center"><span className="w-1 h-6 bg-kh-secondary rounded-full mr-3"></span>{t('pain_title')}</h3>
                                                    <PainPointCard
                                                        prefix="kh"
                                                        subtitle={t('pain_sub')}
                                                        items={[
                                        ...
                                        {activeTab === 'process' && (
                                            <div className="space-y-6 lg:space-y-8 animate-fadeIn">
                                                <h3 className="text-lg md:text-2xl font-bold text-text mb-2 lg:mb-4">{t('process_title')}</h3>
                                        ...
                                        {activeTab === 'solution' && (
                                            <div className="space-y-6 lg:space-y-8 animate-fadeIn">
                                                <h3 className="text-lg md:text-2xl font-bold text-text mb-2 lg:mb-4">{t('solution_title')}</h3>
