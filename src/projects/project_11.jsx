...
// --- COMPONENTS ---
        ...
        const TRANSLATIONS = {
            zh: {
                ...
                conflict_title: "痛點與挑戰", conflict_sub: "升級前的困境",
                pain_1_title: "資訊破碎", pain_1_desc: "學生成績散落在密密麻麻的文字列表中，難以快速掌握缺少的學分或能力短版。",
                pain_2_title: "環境限制", pain_2_desc: "醫院臨床工作站多為舊型電腦，無法支援高運算需求的現代 Web 3D 或複雜動畫。",
                pain_3_title: "缺乏洞察", pain_3_desc: "僅紀錄「分數」而未呈現「趨勢」，學生無法進行有效的自我反思與能力追蹤。",

                process_title: "執行過程", process_sub: "在技術限制中尋求最佳體驗的四個步驟",
                ...
                sol_title: "解決方案",
                sol_1_title: "進度追蹤儀表板", sol_1_benefit: "利用長條圖區分一般與通識課程，學生登入即知「還缺什麼課」，無需人工核對。",
                sol_2_title: "EPA 能力雷達圖", sol_2_benefit: "落實能力導向教育，追蹤學生在特定醫療行為上的信任層級變化。",
                sol_3_title: "自我評估落差分析", sol_3_benefit: "直觀呈現「自評」與「師評」的分數落差，幫助學生看見盲點。",

                gallery_title: "成果展示", gallery_desc: "從純文字到全方位成長地圖的轉變。",
                                ...
                                <div className="relative w-full h-full flex flex-col items-center justify-center">
                                    <div className="flex-1 min-h-0 w-full flex items-center justify-center">
                                        <PreviewFrame
                                            ref={imageScrollRef}
                                            resizable
                                            chromeClassName="bg-tmu-dark-light"
                                            showChrome={showBrowserHeader}
