                            ...
                            <div className="container max-w-7xl mx-auto px-8 z-20">
                                <div className="max-w-5xl text-left">
                                    ...
                                    <h1 className={`text-5xl lg:text-7xl font-heading font-black mb-8 leading-tight text-white drop-shadow-2xl text-left ${loading ? 'opacity-0' : 'fade-in-up'}`} style={{ animationDelay: '0.2s' }}>
                                        ...
                                        {t('title_main')}<br /><span className="text-transparent bg-clip-text" style={{ backgroundImage: 'linear-gradient(to right, #00D4FF, #6C63FF)' }} dangerouslySetInnerHTML={{ __html: t('title_sub').replace('\n', '<br/>') }}></span>
                                    </h1>
                                ...
                                <div className="w-full h-full flex flex-col glass-panel relative min-h-0">
                                    ...
                                    <div className="sticky top-0 bg-police-dark/95 backdrop-blur-xl z-30 border-b border-border/10 shrink-0">
                                        <div className="p-4 lg:p-8 pb-0 lg:pb-0">
                                            ...
                                            <p className="text-text/60 text-xs lg:text-sm mb-2 lg:mb-4">Police street surveillance image recognition and monitoring system</p>
