...
export const translations: Record<Lang, Translations> = {
  zh: {
    ...
    about_p3: "我把 <strong class='text-white'>AI 與自動化</strong>嵌進實際接案流程：當客戶從 LINE 官方帳號或表單送出需求後，Make 會先整理欄位、交由 <span class='text-purple-400 font-bold'>Gemini</span> 摘要需求與判斷類型，再寫入 <span class='text-purple-400 font-bold'>Google Sheets</span> 作為追蹤資料庫，最後分流發送 LINE 回覆與 Email 通知。這讓我在正式溝通前就能掌握需求背景、預算、時程與風險，回覆更快，也更精準。",
    ...
    contact_sub: '有專案合作需求？透過 LINE 或表單留下資訊，我會帶著整理好的需求摘要回覆你。',
  ...
  en: {
    ...
    about_p3: "I embed <strong class='text-white'>AI and automation</strong> directly into my freelance workflow. When a client submits a request through LINE or a form, Make structures the fields, asks <span class='text-purple-400 font-bold'>Gemini</span> to summarize the need and classify the request, saves it to <span class='text-purple-400 font-bold'>Google Sheets</span>, then routes LINE replies and email notifications. Before the first conversation, I already understand the context, budget, timeline, and risks, so my response is faster and more precise.",
    ...
    contact_sub: 'Have a project in mind? Send it through LINE or the form, and I will reply with the brief already organized.',
